        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductDesc = table.Column<string>(maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesOrderLine_Products_ProductModelId",
                        column: x => x.ProductModelId,
                        principalTable: "Products",
                        principalColumn: "ProductID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SalesOrderLine_Sales_SalesId",
                        column: x => x.SalesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesOrderLine_ProductModelId",
                table: "SalesOrderLine",
                column: "ProductModelId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesOrderLine_SalesId",
                table: "SalesOrderLine",
                column: "SalesId");
        }
