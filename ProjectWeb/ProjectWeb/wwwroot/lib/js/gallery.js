...
var ajaxOptions = 
{
    ...
    success: function (result) 
    {
        ...
        $("#SuccessMessage .list-group-item").html(result);
        loadGallerySelect();
...
function loadGallerySelect() 
{
    ...
    $.ajax({
        ...
        $("#FailMessage .list-group-item").html("Could not load the Galleries.");
...
function AjaxUpdateGallery(formData) 
{
    ...
    console.log(form_Data.getAll('AltText[]'));
    ...
    console.log(form_Data.getAll('Image_Id[]'));
    console.log(form_Data.getAll('imageId[]'));
    console.log(form_Data.getAll('imageCaption[]'));
    console.log(form_Data.getAll('description[]'));
    console.log(form_Data.getAll('altText[]'));
    ...
    var ajaxOptions = 
            {
                ...
                success: function (result) {
                        ...
                        $("#SuccessMessage").modal('show');
                        $("#SuccessMessage .list-group-item").html("Gallery Updated Successfully.");
                      
                        },
                error: function () {
                            $("#FailMessage").modal('show');
                            $("#FailMessage .list-group-item").html("Could Not Update Gallery.");
                        }
            }
...
function confirmDeleteGallery() 
    {
        ...
        ajaxOptions.success = function () 
        {
            ...
            $("#SuccessMessage").modal('show');
            $("#SuccessMessage .list-group-item").html("Work has done !");
             loadGallerySelect();
             //viewgallery();
        };
        ...
        { $("#DeleteGalleryModal").modal('hide');
            $("#FailMessage").modal('show');
            $("#FailMessage .list-group-item").html("Work Fail !");
